<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="web_GameTiengVietBasic1.aspx.cs" Inherits="web_module_module_BaiTap_web_GameTiengVietBasic1" %>
...
<body>
    <form id="form1" runat="server">
        <div class="main__tiengvietbasic">
            <div class="container">
                <h4 class="tiengvietbasic__heading display-4">Bài học vần ip và up</h4>
                <%--<h4 class="math__title"><span>1</span>Điền vào chỗ trống :</h4>--%>
                <div class="row">
                    <p class="tiengvietbasic__title"><span>1)&nbsp;</span>Hãy điền từ ip hoặc up </p>
                    <div class="col-lg-2 col-md-2 col-sm-4 col-6">
                        <div class="tiengvietbasic__box">
                            <span class="tiengvietbasic__content">Nhân d
                            <input class="input__tiengvietbasic" id="txtread" runat="server"  type="text" name="name" value="ịp" /></span>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-4 col-6">
                        <div class="tiengvietbasic__box">
                            <span class="tiengvietbasic__content">Cái nh
                            <input class="input__tiengvietbasic" id="txtread1" runat="server" style="<%=mau1%>" type="text" name="name" value="íp" /></span>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-4 col-6">
                        <div class="tiengvietbasic__box">
                            <span class="tiengvietbasic__content">Gi<input class="input__tiengvietbasic" id="txtread2" runat="server" style="<%=mau2%>" type="text" name="name" value="úp" />
                                đỡ</span>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-4 col-6">
                        <div class="tiengvietbasic__box">
                            <span class="tiengvietbasic__content">Nh
                            <input class="input__tiengvietbasic" type="text" id="txtread3" runat="server" style="<%=mau3%>" name="name" value="ịp" /> điệu</span>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-4 col-6">
                        <div class="tiengvietbasic__box">
                            <span class="tiengvietbasic__content">T<input class="input__tiengvietbasic" type="text" id="txtread4" runat="server" name="name" value="úp" /> lều</span>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-4 col-6">
                        <div class="tiengvietbasic__box">
                            <span class="tiengvietbasic__content">Con ch<input class="input__tiengvietbasic" id="txtread5" runat="server" type="text" name="name" value="íp" />
                            </span>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="baitap2">
                        ...
                        <p>Mênh mông biển lúa đâu trời đ<input class="input__tiengvietbasic2" id="txtlisten" runat="server" type="text" name="name" value="ẹp" />
                            hơn</p>
