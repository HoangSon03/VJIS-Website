<%@ Page Title="" Language="C#" MasterPageFile="~/WebSiteMasterPage.master" AutoEventWireup="true" CodeFile="web_NewsDetail.aspx.cs" Inherits="web_module_web_About" %>
            ...
            <div class="row">
                ...
                <div class="content_sky_text col-md-9 col-sm-12">
                    <asp:Repeater runat="server" ID="rpNews">
                        <ItemTemplate>
                            <h3 id="hibodywrapper_lblGioiThieu"><%#Eval("news_title") %></h3>
