<%@ Page Title="" Language="C#" MasterPageFile="~/WebSiteMasterPage.master" AutoEventWireup="true" CodeFile="web_LeHoiTheThao.aspx.cs" Inherits="web_module_module_LeHoiLon_web_LeHoiTheThao" %>
        ...
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <span id="higlobal_lblNoiDung">Lễ hội thể thao tại trường Việt Nhật</span>
                </li>
            </ol>
        </div>
    </div>
                ...
                <div class="content_sky_text col-md-8 col-sm-12">
                    ...
                    <div class="block-lien-quan">
                        ...
                        <div class="block-list">
                            ...
                            <a href="le-hoi-hoa-anh-dao-tai-truong-viet-nhat" class="list_item">
                                <h3 class="title-list-item"><i class="fa fa-angle-double-right"></i>&nbsp; Lễ hội hoa anh đào</h3>
                            </a>
                        </div>
                    </div>
                </div>
