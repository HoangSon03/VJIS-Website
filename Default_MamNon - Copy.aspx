<%@ Page Title="" Language="C#" MasterPageFile="~/Wensite_MasterPage_MamNon.master" AutoEventWireup="true" CodeFile="Default_MamNon - Copy.aspx.cs" Inherits="Default_MamNon" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container-1">
        <div class="content-2">
            ...
            <br>
            <p>
                Các ứng dụng trò chơi trực tuyến với thiết kế sống động bởi hình ảnh 3D chất lượng đem đến một sân chơi hoàn toàn chân thực, dành cho các bạn học sinh mầm non từ 2 đến 5 tuổi được áp dụng duy nhất tại Việt Nhật mầm non. Game dành cho trẻ em nhằm rèn luyện trí thông minh và sự sáng tạo cho các bạn nhỏ kích thích trí tưởng tượng, nhận thức của trẻ. Không những vậy, game còn giúp trẻ tập trung, tập cho trẻ tư duy logic trong nhiều trường hợp. Với giao diện đơn giản, tươi vui màu sắc bắt mắt, âm thanh minh họa sinh động phù hợp với mọi lứa tuổi của trẻ em.
            </p>
            <br>
            <div class="content-sub">
                <div class="cts-img">
                    <img src="images/GioiThieuUngDung/NenLoaiGame.png" alt="" />
                </div>
                <div class="cts-text">
