...
<asp:Content ID="Content5" ContentPlaceHolderID="hibodywrapper" runat="Server">
    <script type="text/javascript">
        ...
        function checkNULL() {
            var CityName = document.getElementById('<%= txtUserName.ClientID%>');
    ...
    <dx:ASPxPopupControl ID="popupControl" runat="server" Width="600px" Height="550px" CloseAction="CloseButton" ShowCollapseButton="True" ShowMaximizeButton="True" ScrollBars="Auto" CloseOnEscape="true" Modal="True"
