<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_NhapSach.aspx.cs" Inherits="admin_page_module_function_module_NhapSach" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="hibodywrapper" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function checkNULL() {
            var CityName = document.getElementById('<%= txtTongTien.ClientID%>');
        ...
        <div class="form-group table-responsive">
            <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="nhapsach_id" Width="60%">
                <Columns>
                    ...
                    <dx:GridViewDataColumn Caption="Ngày nhập" FieldName="nhapsach_createday" HeaderStyle-HorizontalAlign="Center" Width="30%"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Tổng tiền" FieldName="nhapsach_tongtien" HeaderStyle-HorizontalAlign="Center" Width="30%"></dx:GridViewDataColumn>
                </Columns>
                ...
                <asp:UpdatePanel ID="udPopup" runat="server">
                    <ContentTemplate>
                        <div class="popup-main">
                            <div class="div_content col-12">
                                <div class="col-12 form-group">
                                    <label class="col-2 form-control-label">Mã đơn hàng :</label>
                                    <div class="col-10">
                                        <asp:TextBox ID="txtCode" runat="server" ClientIDMode="Static" CssClass="form-control boxed" Width="95%"> </asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="popup-main">
                            <div class="div_content col-12">
                                <div class="col-12 form-group">
                                    <label class="col-2 form-control-label">Ngày nhập :</label>
                                    <div class="col-10">
                        ...
                        <div class="popup-main">
                            <div class="div_content col-12">
                                <div class="col-12 form-group">
                                    <label class="col-2 form-control-label">Tổng tiền :</label>
                                    <div class="col-10">
                                        <asp:TextBox ID="txtTongTien" runat="server" ClientIDMode="Static" CssClass="form-control boxed" Width="95%"> </asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
