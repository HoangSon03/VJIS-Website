...
public partial class admin_page_module_function_module_BoSungSach : System.Web.UI.Page
{
    ...
    protected void btnChiTiet_Click(object sender, EventArgs e)
    {
        ...
        var getData = (from tb in db.tbThuVien_NhapSaches
                       ...
                       select tb).Single();
        txtNoiDung.Text = getData.nhapsach_content;
        txtDonHang.Text = getData.nhapsach_code;
        dtNgayNhap.Value = getData.nhapsach_createdate.ToString();
