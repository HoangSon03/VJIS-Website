<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_QuanLyAnPham_Update.aspx.cs" Inherits="admin_page_module_function_module_QuanLyAnPham_Update" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="headlink" runat="Server">
    ...
    <script src="../../../Magnific-Popup-master/libs/jquery/jquery.js"></script>
    ...
    <script>
        ...
        function checkNULL() {
            ...
            if (nxb.length != 4) {
                swal('Vui lòng nhập lại năm xuất bản!', '', 'warning').then(function () { txtNamXuatBan.focus(); });
                return false;
            }
        ...
        function showImg1_1(imge) {
           
            console.log(imge);
            $('#imgPreview1').attr('src', imge);
           // $("#imgPreview1").attr("src","/uploadimages/file-sach-hoaintt/2tvasato.obu.jpg");
...
<asp:Content ID="Content5" ContentPlaceHolderID="hibodywrapper" runat="Server">
        ...
        <div class="col-sm-10 align_back">
            <div class="container">
                ...
                <div class="add_Product row">
                    ...
                    <div class="col-12">
                        <h2 class="heading-nhapsach">Thông tin sách</h2>
                            ...
                            <div class="col-4 form-group">
                                ...
                                <div class="col-10">
                                    <asp:DropDownList runat="server" ID="ddlLoaiAnPham" CssClass="form-control">
                                        ...
                                        <asp:ListItem Value="Truyện Tranh">Truyện Tranh</asp:ListItem>
                                        <asp:ListItem Value="Tạp Chí">Tạp Chí</asp:ListItem>
                                        <asp:ListItem Value="Bản Đồ">Bản Đồ</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 form-group">
                         ...
                         <div class="col-12 form-group">
                            <div class="col-6 mt-1">
                                ...
                                <div class="col-9">
                                    <dx:ASPxComboBox ID="ddlSoPhanLoai" runat="server" TextField="phanloai_name"
                    ...
                    <div class="col-12 form-group btn-pad" style="display: block;">
                        <a id="btnCapNhat" runat="server" class="btn btn-primary" onclick="return checkNULL()" onserverclick="btnCapNhat_ServerClick">Cập Nhật</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script> 
        ...
        function showImg(img) {
            $('#hibodywrapper_imgPreview').attr('src', img);
        }
