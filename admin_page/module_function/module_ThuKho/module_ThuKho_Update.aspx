<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_ThuKho_Update.aspx.cs" Inherits="admin_page_module_function_module_ThuKho_module_ThuKho_Update1" %>
                                    ...
                                    <asp:Repeater runat="server" ID="rp_grvChiTiet">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="javascript:void(0)" id="btnXoa<%#Eval("thuvien_sach_id") %>" onclick="confirmDel(<%#Eval("thuvien_sach_id") %>)">Xóa</a>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
