<%@ Page Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_LienHe.aspx.cs" Inherits="admin_page_module_function_module_WebSite_module_LienHe" %>
        ...
        <div class="form-group table-responsive">
            <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="lienhe_id" Width="100%">
                <Columns>
                    ...
                    <dx:GridViewDataColumn Caption="Cơ Sở" FieldName="lienhe_title" HeaderStyle-HorizontalAlign="Center" Width="20%"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Địa Chỉ" FieldName="lienhe_address" HeaderStyle-HorizontalAlign="Center" Width="30%" Settings-AllowEllipsisInText="True"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Số Điện Thoại" FieldName="lienhe_phone" HeaderStyle-HorizontalAlign="Center" Width="30%" Settings-AllowEllipsisInText="True"></dx:GridViewDataColumn>
                   <%-- <dx:GridViewDataColumn Caption="Map" FieldName="lienhe_map" HeaderStyle-HorizontalAlign="Center" Width="30%" Settings-AllowEllipsisInText="True"></dx:GridViewDataColumn>--%>
                </Columns>
                                    ...
                                    <div class="col-12">
                                        <div class="col-8">
                                            <div class="col-12 form-group">
                                                <label class="col-2 form-control-label">Tên Cở Sở:</label>
                                                <div class="col-10">
