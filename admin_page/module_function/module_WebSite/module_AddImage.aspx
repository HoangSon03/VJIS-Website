<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_AddImage.aspx.cs" Inherits="admin_page_module_function_module_WebSite_module_AddImage" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="hibodywrapper" runat="Server">
    ...
    <div class="card card-block">
        <div class="card-title-block">
            <h2 class="title">Abum hình ảnh</h2>
        </div>
        <div class="col-12 form-group">
            <label class="col-2 form-control-label">Loại hình ảnh:</label>
            <div class="col-2">
                <dx:ASPxComboBox ID="ddllop" runat="server" TextField="imagelibcate_title" ValueField="imagelibcate_id" ClientInstanceName="ddlloaisanpham" CssClass="" Width="95%"></dx:ASPxComboBox>
            </div>
        </div>
        <div class="row">
                ...
                <asp:UpdatePanel ID="upUpload" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                    <ContentTemplate>
                        <span class="button-addimg fileinput-button">
                            ...
                            <div id="up1" class="">
                                <asp:FileUpload CssClass="hidden-up" ID="files" name="files[]" ClientIDMode="Static" runat="server" multiple accept="image/jpeg, image/png, image/gif," />
                                <button type="button" id="btnClick" class="btn-chang" onclick="clickavatar1()">
                                    <img src="/admin_images/up-img.png" style="max-width: 100%; height: 150px" />
                                </button>
                            </div>
                            <button type="button" id="btnImage" class="btn-chang" runat="server" onserverclick="btnImage_ServerClick" style="display: none">
                            </button>
                        </span>
                                ...
                                <ul class="thumb-Images">
                                    <asp:Repeater ID="rpImageListing" runat="server">
                                        <ItemTemplate>
                                            <li>
                                                <div class="img-wrap">
                                                    <a onclick="xoaImage(<%#Eval("imagelib_id") %>)"><span class="close">&times;</span></a>
                                                    <img class="thumb" src="<%#Eval("imagelib_image") %>" />
                        ...
                        <div class="form-group d-flex align-items-center justify-content-space-between">
                            <asp:Button ID="btnUpload" CssClass="btn btn-primary fileinput-button" runat="server" Text="Lưu tất cả" OnClick="btnUpload_Click" />
                        </div>
                    </ContentTemplate>
                    <Triggers>
    ...
    <asp:Button ID="btnHoanThanh" runat="server" OnClick="btnHoanThanh_Click" CssClass="btn btn-primary" Text="Hoàn thành" />
</asp:Content>
<asp:Content ID="Content6" ContentPlaceHolderID="hibodybottom" runat="Server">
    <script type="text/javascript">
        function clickavatar1() {
            $("#up1 input[type=file]").click();
                //$("#<%=btnHoanThanh.ClientID%>").click();
        }
