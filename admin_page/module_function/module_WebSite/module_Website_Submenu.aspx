<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_Website_Submenu.aspx.cs" Inherits="admin_page_module_function_module_Website_Submenu" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="hibodywrapper" runat="Server">
    ...
    <div class="card card-block">
        ...
        <div class="form-group table-responsive">
            <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="websitesubmenu_id" Width="100%">
                <Columns>
                    <dx:GridViewCommandColumn ShowSelectCheckbox="True" SelectAllCheckboxMode="Page" VisibleIndex="0" Width="5%">
                    </dx:GridViewCommandColumn>
                     <dx:GridViewDataColumn Caption="Tên loại" FieldName="websitemenu_title" HeaderStyle-HorizontalAlign="Center" Width="30%"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Tiêu đề" FieldName="websitesubmenu_title" HeaderStyle-HorizontalAlign="Center" Width="20%"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Vị trí" FieldName="websitesubmenu_position" HeaderStyle-HorizontalAlign="Center" Width="20%"></dx:GridViewDataColumn>
                     <dx:GridViewDataColumn Caption="Tình trạng" FieldName="websitesubmenu_active" HeaderStyle-HorizontalAlign="Center" Width="30%"></dx:GridViewDataColumn>
                        ...
                        <div class="popup-main">
                            ...
                            <div class="div_content col-12">
                                <div class="col-12 form-group">
                                    ...
                                    <div class="col-10">
                                        <input runat="server" id="txtvitri" type="text" class="form-control boxed"  style="width: 95%" />
                                        <%--<asp:TextBox ID="txtvitri" runat="server" ClientIDMode="Static" CssClass="form-control boxed" Width="95%"> </asp:TextBox>--%>
                                    </div>
                                </div>
                            </div>
