<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_Website_PhuHuynhVaHocSinhCate.aspx.cs" Inherits="admin_page_module_function_module_Website_PhuHuynhVaHocSinhCate" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="hibodywrapper" runat="Server">
    ...
    <div class="card card-block">
        ...
        <div class="form-group table-responsive">
            <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="phuhuynhvahocsinhcate_id" Width="60%">
                <Columns>
                    <dx:GridViewCommandColumn ShowSelectCheckbox="True" SelectAllCheckboxMode="Page" VisibleIndex="0" Width="5%">
                    </dx:GridViewCommandColumn>
                    <dx:GridViewDataColumn Caption="Loại" FieldName="websitemenu_title" HeaderStyle-HorizontalAlign="Center" Width="30%"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Tên" FieldName="phuhuynhvahocsinhcate_title" HeaderStyle-HorizontalAlign="Center" Width="30%"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Vị trí" FieldName="phuhuynhvahocsinhcate_position" HeaderStyle-HorizontalAlign="Center" Width="20%"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Tình trạng" FieldName="phuhuynhvahocsinhcate_active" HeaderStyle-HorizontalAlign="Center" Width="30%"></dx:GridViewDataColumn>
                </Columns>
                        ...
                        <div class="popup-main">
                              <div class="div_content col-12">
                                <div class="col-12 form-group">
                                    <label class="col-2 form-control-label">Loại Menu:</label>
                                    <div class="col-10">
                                          <dx:ASPxComboBox ID="ddlgroup" runat="server" ValueType="System.Int32" TextField="websitemenu_title" ValueField="websitemenu_id" ClientInstanceName="ddlgroup" CssClass="" Width="95%"></dx:ASPxComboBox>
                                    </div>
                                </div>
                            </div>
                            <div class="div_content col-12">
