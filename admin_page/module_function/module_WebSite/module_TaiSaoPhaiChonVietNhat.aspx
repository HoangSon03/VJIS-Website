<%@ Page Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_TaiSaoPhaiChonVietNhat.aspx.cs" Inherits="admin_page_module_function_module_TaiSaoPhaiChonVietNhat" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="hibodywrapper" runat="Server">
    ...
    <div class="card card-block">
        ...
        <div class="form-group table-responsive">
            <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="taisaochonvietnhat_id" Width="100%">
                <Columns>
                    <dx:GridViewCommandColumn ShowSelectCheckbox="True" SelectAllCheckboxMode="Page" VisibleIndex="0" Width="5%">
                    </dx:GridViewCommandColumn>
                    <dx:GridViewDataColumn Caption="Hình ảnh" FieldName="taisaochonvietnhat_image" Width="15%" HeaderStyle-HorizontalAlign="Center" CellStyle-VerticalAlign="Middle">
                        <DataItemTemplate>
                            <img src="<%#Eval("taisaochonvietnhat_image") %>" height="100" />
                        </DataItemTemplate>
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Loại" FieldName="taisaochonvietnhat_loai" HeaderStyle-HorizontalAlign="Center" Width="10%"></dx:GridViewDataColumn>
                </Columns>
    ...
    <dx:ASPxPopupControl ID="popupControl" runat="server" Width="1400px" Height="800px" CloseAction="CloseButton" ShowCollapseButton="True" ShowMaximizeButton="True" ScrollBars="Auto" CloseOnEscape="true" Modal="True"
        PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" ClientInstanceName="popupControl" ShowFooter="true"
        HeaderText="Tại sao phải chọn Việt Nhật" AllowDragging="True" PopupAnimationType="Fade" EnableViewState="False" AutoUpdatePosition="true" ClientSideEvents-CloseUp="function(s,e){grvList.Refresh();}">
        <ContentCollection>
                        ...
                        <div class="popup-main">
                            <div class="div_content col-12">
                                <div class="col-12 form-group">
                                    ...
                                    <div class="col-10">
                                        <asp:DropDownList ID="ddlgroup" runat="server" CssClass="form-control boxed" Width="95%" Height="20px">
                                            <asp:ListItem Value="1" Text="Chương trình học và đào tạo có tính kế thừa"></asp:ListItem>
                                            <asp:ListItem Value="2" Text="Môi trường học tập lý tưởng"></asp:ListItem>
                                            <asp:ListItem Value="3" Text="Cơ sở vật chất khang trang, hiện đại"></asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                            ...
                                            <div class="col-12 form-group">
                                                <div class="col-12">
                                                    <dx:ASPxHtmlEditor ID="edtMoTa" ClientInstanceName="edtMoTa" runat="server" Width="100%" Height="300px" Border-BorderStyle="Solid" Border-BorderWidth="1px" Border-BorderColor="#dddddd">
