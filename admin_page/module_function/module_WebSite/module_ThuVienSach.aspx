<%@ Page Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_ThuVienSach.aspx.cs" Inherits="admin_page_module_function_module_ThuVienSach" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="hibodywrapper" runat="Server">
        ...
        <div class="form-group table-responsive">
            <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="thuvien_sach_id" Width="100%">
                <Columns>
                    ...
                    <dx:GridViewDataColumn Caption="Hình ảnh sách" FieldName="thuvien_sach_image" HeaderStyle-HorizontalAlign="Center" Width="20%">
                        <DataItemTemplate>
                            <img src="<%#Eval("thuvien_sach_image") %>" height="100" />
                        </DataItemTemplate>
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Tủ sách" FieldName="thuvien_tusach_name" HeaderStyle-HorizontalAlign="Center" Width="20%">
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Tên sách" FieldName="thuvien_sach_name" HeaderStyle-HorizontalAlign="Center" Width="20%">
                    </dx:GridViewDataColumn>
                </Columns>
    ...
    <dx:ASPxPopupControl ID="popupControl" runat="server" Width="800px" Height="500px" CloseAction="CloseButton" ShowCollapseButton="True" ShowMaximizeButton="True" ScrollBars="Auto" CloseOnEscape="true" Modal="True"
        ...
        HeaderText="Thư viện sách" AllowDragging="True" PopupAnimationType="Fade" EnableViewState="False" AutoUpdatePosition="true" ClientSideEvents-CloseUp="function(s,e){grvList.Refresh();}">
        <ContentCollection>
                                ...
                                <div class="col-12">
                                    <div class="col-12">
                                        <div class="col-12 form-group">
                                            ...
                                            <div class="col-2">
                                                <dx:ASPxComboBox ID="ddllop" runat="server" TextField="thuvien_tusach_name" ValueField="thuvien_tusach_id" ClientInstanceName="ddllop" CssClass="" Width="95%"></dx:ASPxComboBox>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="col-12">
