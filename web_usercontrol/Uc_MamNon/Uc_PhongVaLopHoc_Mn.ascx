<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Uc_PhongVaLopHoc_Mn.ascx.cs" Inherits="web_usercontrol_Uc_MamNon_Uc_PhongVaLopHoc_Mn" %>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="about-content-mnbody">
                                        ...
                                        <div class="more-mnbody">
                                            <a class="btn btn-mnbody" href="../../tin-tuc/<%#cls_ToAscii.ToAscii(Eval("newscate_title").ToString()) %>/<%#cls_ToAscii.ToAscii(Eval("news_title").ToString()) %>-<%#Eval("news_id") %>">Xem Thêm</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
