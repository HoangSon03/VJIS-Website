<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Uc_FormDk_Thpt.ascx.cs" Inherits="web_usercontrol_Uc_THPT_Uc_FormDk_Thpt" %>
    ...
    <div class="content-form-dang-ky">
        ...
        <div class="form">
            ...
            <div class="form-group">
                ...
                <div class="input-form-dang-ky">
                    <input type="text" name="age" id="txt_age" runat="server" class="form-control" placeholder="Độ Tuổi" />
                </div>
            </div>
        </div>
