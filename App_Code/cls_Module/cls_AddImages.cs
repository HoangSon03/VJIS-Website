...
public class cls_AddImages
{
    ...
    public bool Linq_suaimagesach(int sach_id, string image)
    {
        tbThuVien_Sach update = db.tbThuVien_Saches.Where(x => x.thuvien_sach_id == sach_id).FirstOrDefault();
        if (image != null)
        {
