...
public class cls_ExcelApiTest
{
    ...
    public string GetCellData(string sheetName, int colNumber, int rowNumber)
    {
        ...
        if (sheets.ContainsValue(sheetName))
        {
            ...
            xl.Worksheet ws = workbook.Worksheets[sheetValue] as xl.Worksheet;
            xl.Range range = ws.UsedRange;
            value = ((range.Cells[rowNumber, colNumber] as xl.Range).Value2) + "";
    ...
    public string GetCellDataName(string sheetName, string colName, int rowNumber)
    {
        string value = "";
        int sheetValue = 0;
        int colNumber = 0;
        ...
        if (sheets.ContainsValue(sheetName))
        {
            ...
            //{
            //    string colNameValue = ((range.Cells[1, i] as xl.Range).Value2).ToString(); // i = 3 là hàng 3 có chứa các tên column
