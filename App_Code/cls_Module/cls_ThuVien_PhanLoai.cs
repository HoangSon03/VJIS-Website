...
/// </summary>
public class cls_ThuVien_PhanLoai
{
    dbcsdlwebsiteDataContext db = new dbcsdlwebsiteDataContext();
	public cls_ThuVien_PhanLoai()
	{
		//
    ...
    {
        tbThuVien_PhanLoai delete = db.tbThuVien_PhanLoais.Where(x => x.phanloai_id == newscate_id).FirstOrDefault();
        db.tbThuVien_PhanLoais.DeleteOnSubmit(delete);
        try
        {
            db.SubmitChanges();
            return true;
