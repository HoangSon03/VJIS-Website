...
public class cls_NewsCate
{
    ...
    {
        tbWebsite_NewsCate insert = new tbWebsite_NewsCate();
        ...
        db.tbWebsite_NewsCates.InsertOnSubmit(insert);
        if (SEO_LINK != "")
        {
    ...
    {
        tbWebsite_NewsCate update = db.tbWebsite_NewsCates.Where(x => x.newscate_id == newscate_id).FirstOrDefault();
    ...
    {
        tbWebsite_NewsCate delete = db.tbWebsite_NewsCates.Where(x => x.newscate_id == newscate_id).FirstOrDefault();
        db.tbWebsite_NewsCates.DeleteOnSubmit(delete);
        try
        {
            db.SubmitChanges();
            return true;
